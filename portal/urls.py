...
urlpatterns = [
    ...
    path('section/<int:section_id>/folder/assignment/delete/<int:folder_id>/<int:assignment_id>/file', views.deleteFilesFromAssignment, name='deleteFilesFromAssignment'),
